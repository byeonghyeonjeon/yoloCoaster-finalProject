 ...
 * 수정일 수정자 수정내용
 * ---------- ------ ------------------------
 * 2018. 6. 23. Brown 최초 생성
 *
 * </pre>
 */
public class PageVO {

	private int pboard_seq; // 게시판 선택
	...
	public String toString() {
		return "PageVO [pboard_seq=" + pboard_seq + ", pageSize=" + pageSize
				+ ", firstPageNo=" + firstPageNo + ", prevPageNo=" + prevPageNo
				+ ", startPageNo=" + startPageNo + ", pageNo=" + pageNo
				+ ", endPageNo=" + endPageNo + ", nextPageNo=" + nextPageNo
				+ ", finalPageNo=" + finalPageNo + ", totalCount=" + totalCount
				+ ", blockSize=" + blockSize + ", startRowNum=" + startRowNum
				+ ", endRowNum=" + endRowNum + "]";
	}
